...
🛎️ **Services**  
FasrAPI microservice predicting restaurant tab (Docker-ready).  → [`fast api1`](https://github.com/CJRockball/pred_service)

FastAPI microservice predicting personality (Docker-ready).  → [`fast api2`](https://github.com/CJRockball/xgb-predict)
...
![Scikit-learn](https://img.shields.io/badge/Sklearn-2878A2?style=plastic&logo=pandas&logoColor=white)
![Langgraph](https://img.shields.io/badge/LangGraph-2472f0?style=plastic&logo=langgraph&logoColor=white)
![Statsmodels](https://img.shields.io/badge/Statsmodels-5236ad?style=plastic&logo=statsmodels&logoColor=white)
